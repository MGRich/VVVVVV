...
void titlerender(Graphics& dwgfx, mapclass& map, Game& game, entityclass& obj, UtilityClass& help, musicclass& music)
{
    ...
    else
    {
        ...
        {
            dwgfx.Print(-1, 50, "This branch uses bits from", tr, tg, tb, true);
            dwgfx.Print(-1, 65, "VVVVVV: Community Edition, which has", tr, tg, tb, true);
            dwgfx.Print(-1, 100, "accepted contributions from:", tr, tg, tb, true);
            dwgfx.Print(-1, 115, "Info Teddy", tr, tg, tb, true);
            dwgfx.Print(-1, 130, "AllyTally", tr, tg, tb, true);
            dwgfx.Print(-1, 145, "leo60228", tr, tg, tb, true);
        }
